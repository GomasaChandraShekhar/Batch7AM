Feature: Verify the place order functionality
  ...
  @sout
  Scenario Outline: Verify place order with multiple test data
    Given User is in login page "<url>"
    When User login using "<userEmail>" and "<userPassword>"
    When User add product "<prodName>" to the cart
    Then Verify the product "<prodName>" in the cart
    When User enters "<country>" and place order
    ...
    Examples:
      | url                                                | userEmail                      | userPassword | prodName        | country   |
      | https://rahulshettyacademy.com/client/#/auth/login | gomasachandrashekhar@gmail.com | Gomasa@1988  | ZARA COAT 3     | India     |
      | https://rahulshettyacademy.com/client/#/auth/login | gomasachandrashekhar@gmail.com | Gomasa@1988  | ADIDAS ORIGINAL | Canada    |
      | https://rahulshettyacademy.com/client/#/auth/login | gomasachandrashekhar@gmail.com | Gomasa@1988  | IPHONE 13 PRO   | Australia |
